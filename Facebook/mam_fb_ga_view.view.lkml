  ...
  dimension: creative_name {
    ...
    sql:
      CASE
        ...
        when ${ad_name} ilike '%_TimesChangeMagicRemains1' then 'Time Change Magic Remains v1 Single Image'
  ...
  dimension: mam_region {
    ...
    sql:
      CASE
        ...
        when ${campaign_name} ilike 'MAM_FY21_Winter_Traffic_California' then 'California'
        when ${campaign_name} ilike 'MAM_FY21_Winter_Video_California' then 'California'
