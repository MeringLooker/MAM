view: pdt_fy21_springsummer_adtheorent_1p {
  derived_table: {
    explore_source: mam_dcm {
      ...
      column: total_impressions {field: mam_fy21_springsummer_dcm_view.total_impressions}
      column: total_clicks {field: mam_fy21_springsummer_dcm_view.total_clicks}
      column: total_cost {field: mam_fy21_springsummer_dcm_view.total_cost}
      column: total_views {field: mam_fy21_springsummer_dcm_view.total_views}
      column: total_completes {field: mam_fy21_springsummer_dcm_view.total_completes}
