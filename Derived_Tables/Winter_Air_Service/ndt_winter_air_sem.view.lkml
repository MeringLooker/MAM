view: ndt_winter_air_sem {
  derived_table: {
    explore_source: mam_sem {
      ...
      column: placement {field:mam_sem_view.mam_placement}
      ...
      column: total_conversions {field:mam_sem_view.total_conversions}
      column: total_sessions {field:mam_sem_view.total_sessions}
      column: total_session_duration {field:mam_sem_view.total_session_duration}
      filters: {
