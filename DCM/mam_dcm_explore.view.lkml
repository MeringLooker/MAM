...
explore: mam_dcm {
  ...
  join: mam_fy20_winter_seasonal_dcm_view {
    ...
    type: inner
    sql_on: ${mam_fy20_winter_seasonal_dcm_view.passback_join} = ${mam_dcm_view.passback_join} ;;
  ...
  join: mam_fy20_winter_air_amobee {
    ...
    type: inner
    sql_on: ${mam_fy20_winter_air_amobee.passback_join} = ${mam_dcm_view.passback_join} ;;
    relationship: one_to_many
  }
  ...
  join: mam_ga_userinfo {
    ...
    type: left_outer
    sql_on: ${mam_dcm_view.comp_key} = ${mam_ga_userinfo.join_id} ;;
    relationship: many_to_one
  }
  ...
  join: mam_ga_pageinfo {
    ...
    type: left_outer
    sql_on: ${mam_dcm_view.comp_key} = ${mam_ga_pageinfo.join_id} ;;
    relationship: many_to_one
  }
  ...
  join: mam_ga_events {
    ...
    type: left_outer
    sql_on: ${mam_dcm_view.comp_key} = ${mam_ga_events.join_id} ;;
    relationship: many_to_one
  }
  ...
  join: mam_ga_goals {
    ...
    type: left_outer
    sql_on: ${mam_dcm_view.comp_key} = ${mam_ga_goals.join_id} ;;
    relationship: many_to_one
  }
}
